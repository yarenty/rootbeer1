...
$$__device__$$ 
double org_trifort_rootbeer_runtime_RootbeerGpu_atomicAddGlobal8_a18_5_8_(int array, int index, double value, int * exception){
  char * array_deref;
  double * float_handle;
  int length;
...
$$__device__$$
int java_lang_Boolean_valueOf(char bool_value, int * exception) {
  int return_obj = -1;
