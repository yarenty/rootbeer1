...
public class CompilerSetup {
  ...
  public Set<String> getDontDfs(){
    ...
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: long atomicMinGlobal(long[],int,long)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: int atomicMaxGlobal(int[],int,int)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: long atomicMaxGlobal(long[],int,long)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: int atomicCASGlobal(int[],int,int)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: long atomicCASGlobal(long[],int,long)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: int atomicANDGlobal(int[],int,int)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: long atomicANDGlobal(long[],int,long)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: int atomicORGlobal(int[],int,int)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: long atomicORGlobal(long[],int,long)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: int atomicXORGlobal(int[],int,int)>");
    ret.add("<org.trifort.rootbeer.runtime.RootbeerGpu: long atomicXORGlobal(long[],int,long)>");
