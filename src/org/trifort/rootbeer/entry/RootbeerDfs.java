...
public class RootbeerDfs {
  ...
  public void run(DfsInfo dfs_info) {
    ...
    visited.add(new HierarchySignature("<java.io.PrintStream: void println(java.lang.Object)>"));
    ...
    visited.add(new HierarchySignature("<java.io.PrintStream: void print(java.lang.Object)>"));
    visited.add(new HierarchySignature("<java.io.PrintStream: void print(java.lang.String)>"));
    visited.add(new HierarchySignature("<java.io.PrintStream: void print(boolean)>"));   
    visited.add(new HierarchySignature("<java.io.PrintStream: void print(byte)>"));   
    visited.add(new HierarchySignature("<java.io.PrintStream: void print(char)>"));    
    visited.add(new HierarchySignature("<java.io.PrintStream: void print(short)>"));   
    visited.add(new HierarchySignature("<java.io.PrintStream: void print(int)>"));     
    visited.add(new HierarchySignature("<java.io.PrintStream: void print(long)>"));
