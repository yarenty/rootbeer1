...
public class MethodSignatureUtil {
  ...
  public String classFromSig(String signature){
    String[] tokens = signature.split(":");
    String first = tokens[0].trim();
    return first.substring(1);
  }
  
  public String methodSubSig(String signature){
    String[] tokens = signature.split(":");
  ...
  public static void main(String[] args){
    ...
    System.out.println(util.classFromSig(sig));
    System.out.println(util.methodSubSig(sig));
  }
}
