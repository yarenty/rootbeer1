...
package edu.syr.pcpratts.rootbeer.remap;
import java.io.*;
...
class Random implements java.io.Serializable {
     ...
     */
    private final GpuAtomicLong seed;
    ...
    private static final GpuAtomicLong seedUniquifier
        = new GpuAtomicLong(8682522807148012L);
    ...
    public Random(long seed) {
        this.seed = new GpuAtomicLong(initialScramble(seed));
    }
