...
import edu.syr.pcpratts.rootbeer.test.TestApplication;
import java.util.List;
import java.util.ArrayList;

public class MatrixApp implements TestApplication {
  ...
  private boolean verify(){
    for(int i = 0; i < m_ccpu.length; ++i){
      ...
      if(cpu_value != gpu_value){
        ...
        builder.append("Verfiy Failed at: ");
        builder.append(i);
        builder.append("\n");
        builder.append("  cpu_value: ");
        builder.append(cpu_value);
        builder.append("\n");
        builder.append("  gpu_value: ");
        builder.append(gpu_value);
        builder.append("\n");
